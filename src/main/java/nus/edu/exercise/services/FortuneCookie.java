package nus.edu.exercise.services;
...
public class FortuneCookie {
	...
	public String getCookie() {
		return (String) Array.get(COOKIES, randomIndex());
	}

	//return X number of cookie
	public List<String> getCookies(Integer num) {
		List<String> cookieList = new ArrayList<>();
		for(int i = 0; i < num; i ++) {
			cookieList.add(getCookie());
		}
		return cookieList;
	}
